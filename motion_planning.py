...
from planning_utils import a_star, heuristic, create_grid, read_global_home, collinearityPrune
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        data = np.loadtxt(colliders_data, delimiter=',', dtype='Float64', skiprows=3)
